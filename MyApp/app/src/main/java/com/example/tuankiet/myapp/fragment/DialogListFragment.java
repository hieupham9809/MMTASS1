...
public class DialogListFragment extends Fragment implements Observerable {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        while (rooms.hasNext()) {
            ...
            List<SugarUser> sugarUsers = new ArrayList<SugarUser>() {{
                ...
                add(SugarUser.findByName(room.getName()));
            }};
            ...
            for (SugarUser i : sugarUsers) users.add(i.toUser());
            SugarUser ownerRoom=SugarUser.findByName(room.getName());
            diaLst.add(new DialogList(String.valueOf(room.getId()), ownerRoom.getAvatar(), ownerRoom.getDisplayName(), users, lastMsg, (int) unRead));
        }
    ...
    public void onAddDialog(SugarRoom sugarRoom) {
        SugarUser ownerRoom=SugarUser.findByName(sugarRoom.getName());
