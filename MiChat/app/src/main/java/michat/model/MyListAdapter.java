...
public class MyListAdapter extends BaseAdapter {
    ...
    public MyListAdapter(Context aContext,  List<User> listData) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        User country = this.listData.get(position);
        holder.countryNameView.setText(country.getFullName());
        holder.populationView.setText("Status: Online" );
